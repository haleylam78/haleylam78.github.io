...
//Show a random index
function showInfo(data, tabletop) { (data.cheap.elements[getRandomIntInclusive(0,8)].cheap);
	...
	expensive = (data.expensive.elements[getRandomIntInclusive(0,10)].expensive);
}
